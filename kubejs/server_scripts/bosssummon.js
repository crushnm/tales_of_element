...
BlockEvents.rightClicked('kubejs:bosssummon_block', event => {
        ...
        boss_summon(event, 'kubejs:curse_bait_0', 'yahaba', 2)
        ...
        boss_summon(event, 'kubejs:curse_bait_1', 'hand_demon', 2)
        ...
        boss_summon(event, 'kubejs:curse_bait_2', 'susamaru', 2)
        ...
        boss_summon(event, 'kubejs:curse_bait_3', 'kyogai', 2)
        boss_summon(event, 'kubejs:curse_bait_4', 'hakuji', 2)
        ...
        boss_summon(event, 'kubejs:curse_bait_5', 'rui_brother', 2)
        boss_summon(event, 'kubejs:curse_bait_6', 'rui_mother', 2)
        boss_summon(event, 'better_boss:dede', 'better_boss:rongam', 1)
        boss_summon(event, 'kubejs:curse_bait_7', 'axe_hero', 2)
        boss_summon(event, 'kubejs:curse_bait_8', 'pudge_hero', 2)
        boss_summon(event, 'kubejs:curse_bait_9', 'juggernaut_hero', 2)
        boss_summon(event, 'kubejs:curse_bait_10', 'lina_hero', 2)
        boss_summon(event, 'kubejs:curse_bait_11', 'makomo', 2)
        boss_summon(event, 'kubejs:curse_bait_12', 'sabito', 2)
        ...
        boss_summon(event, 'kubejs:curse_bait_13', 'cursed_spirit_grade_11', 2)
        boss_summon(event, 'kubejs:curse_bait_14', 'kez_hero', 2)
        boss_summon(event, 'kubejs:curse_bait_15', 'wei_hero', 2)
        ...
        boss_summon(event, 'kubejs:curse_bait_16', 'rui_father', 2)
        ...
        boss_summon(event, 'kubejs:hunter_scroll_1', 'earthloong', 2)
