...
projectile_damage('rpgadventures:projectile_starshot',20)
projectile_damage('agonysing_hell:projectile_hallucinoshot',21)
projectile_damage('threateningly_mobs:hydra_goo',25)
projectile_damage('chaos_project:projectile_ameshot',27)